...
public class Floating : MonoBehaviour
{
    ...
    void addWaveforce()
    {
        ...
        if (transform.position.y < waveHeight)
        {
            ...
            _rb.AddForce(displacementMultiplier * (-_rb.velocity/8) * waterDrag * Time.deltaTime, ForceMode.VelocityChange);
            _rb.AddForce(displacementMultiplier * (-_rb.angularVelocity/8) * waterAngularDrag * Time.deltaTime, ForceMode.VelocityChange);
        }
    }
}